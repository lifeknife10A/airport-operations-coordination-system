...
# 1. WRITE V1__initial_schema.sql (32 FULL NORMALIZED TABLES)
v1_sql = """-- ============================================================
...
print(f"Successfully updated {v1_path} with 32 normalized tables!")

# 2. GENERATE V2__seed_data.sql WITH 3,200+ UNIQUE RECORDS
lines = [
    "-- ============================================================",
    "-- AIRPORT OPERATIONS COORDINATION SYSTEM (AOCS)",
...
for i in range(1, 61):
    code = f"VT-A{i:03d}"
    al_id = ((i - 1) % 5) + 1  # Indian airlines (1 to 5)
...
for i in range(61, 101):
    ...
    code = f"{pref}{i:03d}"
    al_id = 6 + ((i - 61) % 7) # Intl airlines (6 to 12)
    aircraft_list.append((i, code, al_id))
...
print(f"Successfully generated expanded 32-table seed dataset with 3,200+ rows in {v2_path}")
