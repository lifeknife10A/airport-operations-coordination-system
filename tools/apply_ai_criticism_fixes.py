...
# 1. WRITE V1__initial_schema.sql (36 COMPLETE NORMALIZED TABLES WITH AI FIXES)
v1_sql = """-- ============================================================
...
print(f"Successfully updated {v1_path} with 36 normalized tables!")

# 2. GENERATE V2__seed_data.sql WITH 3,600+ UNIQUE RECORDS
lines = [
    "-- ============================================================",
    "-- AIRPORT OPERATIONS COORDINATION SYSTEM (AOCS)",
    "-- Complete 36-Table Master Hybrid Seed Dataset (3,600+ Unique Rows)",
    "-- Includes AIRCRAFT_TYPES, SLA Timestamps, IATA Delay Codes, and Fixed Cargo Links",
    "-- Author: Krishna Solanki & AOCS Engineering Team",
    "-- ============================================================",
    ""
]
...
# 19. DELAY_LOGS (100) WITH IATA DELAY CODES
lines.append("-- 19. DELAY_LOGS (100)")
iata_codes = ["IATA-31", "IATA-41", "IATA-93", "IATA-12", "IATA-84"]
for fid in range(1, 101):
    dm = (fid * 7) % 110 + 10
    dcode = iata_codes[(fid - 1) % len(iata_codes)]
...
# 21. CARGO_MANIFESTS (150) LINKED DIRECTLY TO FLIGHTS
lines.append("-- 21. CARGO_MANIFESTS (150)")
...
# 22. BAGGAGE_CAROUSELS (30)
lines.append("-- 22. BAGGAGE_CAROUSELS (30)")
for i in range(1, 31):
...
# 23. PASSENGERS (300)
lines.append("-- 23. PASSENGERS (300)")
...
# 24. BOARDING_PASSES (300)
lines.append("-- 24. BOARDING_PASSES (300)")
...
# 26. BAGGAGE_SCAN_EVENTS (300)
lines.append("-- 26. BAGGAGE_SCAN_EVENTS (300)")
...
# 27. MISHANDLED_BAGGAGE (40)
lines.append("-- 27. MISHANDLED_BAGGAGE (40)")
...
# 28. SECURITY_CHECKPOINTS (20)
lines.append("-- 28. SECURITY_CHECKPOINTS (20)")
checkpoints_list = [
...
# 29. PASSENGER_CLEARANCE_LOGS (300)
lines.append("-- 29. PASSENGER_CLEARANCE_LOGS (300)")
...
# 30. IMMIGRATION_RECORDS (120)
lines.append("-- 30. IMMIGRATION_RECORDS (120)")
...
# 31. LOUNGE_VISITS (100)
lines.append("-- 31. LOUNGE_VISITS (100)")
...
# 32. CUSTOMER_FEEDBACK_LOGS (100)
lines.append("-- 32. CUSTOMER_FEEDBACK_LOGS (100)")
...
# 33. AIRLINE_BILLING_INVOICES (24)
lines.append("-- 33. AIRLINE_BILLING_INVOICES (24)")
...
# 34. INVOICE_LINE_ITEMS (72)
lines.append("-- 34. INVOICE_LINE_ITEMS (72)")
...
# 35. NOTIFICATIONS (150)
lines.append("-- 35. NOTIFICATIONS (150)")
notif_titles = [
...
# 36. AUDIT_LOGS (200)
lines.append("-- 36. AUDIT_LOGS (200)")
actions = [
...
print(f"Successfully generated seed data with 36 normalized tables & 3,600+ records in {v2_path}")
