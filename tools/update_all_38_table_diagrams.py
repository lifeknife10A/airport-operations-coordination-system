...
relational_tables_38 = [
    ...
    # ROW 3 (y=880) - OPERATIONS, DELAYS & CARGO
    ...
    {"id": "t_delaycodes", "title": "DELAY_CODES", "x": 890, "y": 880, "w": 220, "fields": [("delay_code", "PK"), ("category", ""), ("description", "")]},
    {"id": "t_delays", "title": "DELAY_LOGS", "x": 1140, "y": 880, "w": 230, "fields": [("flight_id", "FK -> FLIGHTS.flight_id"), ("delay_seq_no", "PK"), ("delay_code", "FK -> DELAY_CODES.delay_code"), ("delay_minutes", "")]},
    {"id": "t_fuel", "title": "FUEL_LOGS", "x": 1400, "y": 880, "w": 230, "fields": [("fuel_log_id", "PK"), ("fuel_density", ""), ("task_id", "FK -> TASKS.task_id")]},
    {"id": "t_cargo", "title": "CARGO_MANIFESTS", "x": 1660, "y": 880, "w": 240, "fields": [("cargo_id", "PK"), ("container_id", ""), ("weight_kg", ""), ("cargo_type", ""), ("flight_id", "FK -> FLIGHTS.flight_id")]},
    {"id": "t_baggage", "title": "BAGGAGE_CAROUSELS", "x": 1930, "y": 880, "w": 240, "fields": [("carousel_id", "PK"), ("terminal", ""), ("flight_id", "FK -> FLIGHTS.flight_id")]},

    # ROW 4 (y=1280) - TRAVELERS, PASSENGERS & BRS
    {"id": "t_travelers", "title": "TRAVELERS", "x": 50, "y": 1280, "w": 240, "fields": [("traveler_id", "PK"), ("first_name", ""), ("last_name", ""), ("passport_number", "UNIQUE"), ("nationality", "")]},
    {"id": "t_passengers", "title": "PASSENGERS", "x": 320, "y": 1280, "w": 250, "fields": [("passenger_id", "PK"), ("traveler_id", "FK -> TRAVELERS.traveler_id"), ("flight_id", "FK -> FLIGHTS.flight_id"), ("pnr_code", ""), ("is_transit_passenger", "")]},
    {"id": "t_bpasses", "title": "BOARDING_PASSES", "x": 600, "y": 1280, "w": 250, "fields": [("boarding_pass_id", "PK"), ("barcode_data", ""), ("ticket_number", ""), ("seat_number", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id"), ("flight_id", "FK -> FLIGHTS.flight_id")]},
    {"id": "t_bagtags", "title": "BAG_TAGS", "x": 880, "y": 1280, "w": 240, "fields": [("bag_tag_id", "PK"), ("tag_number", ""), ("weight_kg", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id")]},
    {"id": "t_bagscans", "title": "BAGGAGE_SCAN_EVENTS", "x": 1150, "y": 1280, "w": 260, "fields": [("scan_id", "PK"), ("bag_tag_id", "FK -> BAG_TAGS.bag_tag_id"), ("scan_location", ""), ("scan_timestamp", "")]},
    {"id": "t_mishandled", "title": "MISHANDLED_BAGGAGE", "x": 1440, "y": 1280, "w": 260, "fields": [("report_id", "PK"), ("claim_number", ""), ("incident_type", ""), ("status", ""), ("bag_tag_id", "FK -> BAG_TAGS.bag_tag_id"), ("passenger_id", "FK -> PASSENGERS.passenger_id")]},
    {"id": "t_checkpoints", "title": "SECURITY_CHECKPOINTS", "x": 1730, "y": 1280, "w": 250, "fields": [("checkpoint_id", "PK"), ("checkpoint_name", ""), ("checkpoint_type", ""), ("terminal", "")]},
    {"id": "t_clearance", "title": "PASSENGER_CLEARANCE_LOGS", "x": 2010, "y": 1280, "w": 280, "fields": [("clearance_id", "PK"), ("scan_timestamp", ""), ("clearance_status", ""), ("denial_reason", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id"), ("checkpoint_id", "FK -> SECURITY_CHECKPOINTS.checkpoint_id")]},

    # ROW 5 (y=1660) - BORDER CONTROL, FEEDBACK, BILLING & AUDIT
    {"id": "t_immigration", "title": "IMMIGRATION_RECORDS", "x": 50, "y": 1660, "w": 260, "fields": [("immigration_id", "PK"), ("passport_number", ""), ("visa_type", ""), ("stamp_number", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id")]},
    {"id": "t_lounges", "title": "LOUNGE_VISITS", "x": 340, "y": 1660, "w": 240, "fields": [("visit_id", "PK"), ("lounge_name", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id")]},
    {"id": "t_feedback", "title": "CUSTOMER_FEEDBACK_LOGS", "x": 610, "y": 1660, "w": 260, "fields": [("feedback_id", "PK"), ("rating", ""), ("category", ""), ("passenger_id", "FK -> PASSENGERS.passenger_id")]},
    {"id": "t_invoices", "title": "AIRLINE_BILLING_INVOICES", "x": 900, "y": 1660, "w": 270, "fields": [("invoice_id", "PK"), ("invoice_number", ""), ("total_amount_usd", ""), ("airline_id", "FK -> AIRLINES.airline_id")]},
    {"id": "t_lineitems", "title": "INVOICE_LINE_ITEMS", "x": 1200, "y": 1660, "w": 260, "fields": [("line_item_id", "PK"), ("charge_type", ""), ("amount_usd", ""), ("invoice_id", "FK -> AIRLINE_BILLING_INVOICES.invoice_id")]},
    {"id": "t_notif", "title": "NOTIFICATIONS", "x": 1490, "y": 1660, "w": 220, "fields": [("notification_id", "PK"), ("title", ""), ("user_id", "FK -> USERS.user_id")]},
    {"id": "t_audit", "title": "AUDIT_LOGS", "x": 1740, "y": 1660, "w": 230, "fields": [("log_id", "PK"), ("action", ""), ("created_at", ""), ("user_id", "FK -> USERS.user_id")]}
]
...
xml_parts = [
    ...
    '    <mxGraphModel dx="4200" dy="2800" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="4200" pageHeight="2800" math="0" shadow="0">',
    '      <root>',
    '        <mxCell id="0" />',
    '        <mxCell id="1" parent="0" />',
    '',
    '        <!-- HEADER TITLE -->',
    '        <mxCell id="hdr_title" value="&lt;b style=&quot;font-size: 16px;&quot;&gt;AIRPORT OPERATIONS COORDINATION SYSTEM (AOCS)&lt;/b&gt;&lt;br&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;Complete 38-Table Master 3NF Architecture (Un-bypassable Legal Retention &amp;amp; Complete Cascade Protection)&lt;/span&gt;" style="rounded=0;whiteSpace=wrap;html=1;fontStyle=1;fontSize=14;fillColor=none;strokeColor=default;fontColor=default;" vertex="1" parent="1">',
    '          <mxGeometry x="50" y="30" width="3600" height="50" as="geometry" />',
    '        </mxCell>',
    ''
]
...
for tbl in relational_tables_38:
...
print("Successfully updated AOCS Relational Schema XML with 38 normalized tables!")
