...
xml_parts = [
    ...
    '',
    '        <!-- HEADER TITLE -->',
    '        <mxCell id="hdr_title" value="&lt;b style=&quot;font-size: 16px;&quot;&gt;AIRPORT OPERATIONS COORDINATION SYSTEM (AOCS)&lt;/b&gt;&lt;br&gt;&lt;span style=&quot;font-size: 13px;&quot;&gt;Complete 37-Table Master 3NF Architecture (TRAVELERS &amp;amp; DELAY_CODES Normalized Masters)&lt;/span&gt;" style="rounded=0;whiteSpace=wrap;html=1;fontStyle=1;fontSize=14;fillColor=none;strokeColor=default;fontColor=default;" vertex="1" parent="1">',
...
for tbl in relational_tables_37:
...
print("Successfully updated AOCS Relational Schema XML with 37 normalized tables!")
