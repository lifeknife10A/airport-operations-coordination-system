...
# 1. WRITE V1__initial_schema.sql (35 COMPLETE NORMALIZED TABLES)
v1_sql = """-- ============================================================
...
print(f"Successfully updated {v1_path} with 35 normalized tables!")

# 2. GENERATE V2__seed_data.sql WITH 3,500+ UNIQUE RECORDS
lines = [
    "-- ============================================================",
    "-- AIRPORT OPERATIONS COORDINATION SYSTEM (AOCS)",
    "-- Complete 35-Table Master Hybrid Seed Dataset (3,500+ Unique Rows)",
    "-- Includes CHECKIN_COUNTERS, STANDS, MISHANDLED_BAGGAGE & Denial Reasons",
    "-- Author: Krishna Solanki & AOCS Engineering Team",
    "-- ============================================================",
    ""
]
...
# 9. CHECKIN_COUNTERS (40)
lines.append("-- 9. CHECKIN_COUNTERS (40)")
for i in range(1, 41):
...
# 12. WEATHER_REPORTS (30)
lines.append("-- 12. WEATHER_REPORTS (30)")
...
# 13. GATE_ASSIGNMENT_RULES (60)
lines.append("-- 13. GATE_ASSIGNMENT_RULES (60)")
...
# 15. GROUND_EQUIPMENT (40)
lines.append("-- 15. GROUND_EQUIPMENT (40)")
...
# 17. EQUIPMENT_ASSIGNMENTS (200)
lines.append("-- 17. EQUIPMENT_ASSIGNMENTS (200)")
...
# 18. DELAY_LOGS (100)
lines.append("-- 18. DELAY_LOGS (100)")
...
# 20. CARGO_MANIFESTS (150)
lines.append("-- 20. CARGO_MANIFESTS (150)")
for i in range(1, 151):
...
# 21. BAGGAGE_CAROUSELS (30)
lines.append("-- 21. BAGGAGE_CAROUSELS (30)")
for i in range(1, 31):
...
# 22. PASSENGERS (300) ENHANCED WITH PNR & NAMES
lines.append("-- 22. PASSENGERS (300)")
...
for i in range(1, 301):
    ...
    fid = ((i - 1) % 200) + 1
    lines.append(f"INSERT INTO passengers (passenger_id, first_name, last_name, pnr_code, passport_number, nationality, is_transit_passenger, email, phone_number, flight_id) VALUES ({i}, '{fn}', '{ln}', '{pnr}', '{ppt}', '{nat}', {is_transit}, '{email}', '{phone}', {fid}) ON CONFLICT DO NOTHING;")
lines.append("")

# 23. BOARDING_PASSES (300) ENHANCED WITH IATA BCBP PRINTING FIELDS
lines.append("-- 23. BOARDING_PASSES (300)")
...
# 25. BAGGAGE_SCAN_EVENTS (300)
lines.append("-- 25. BAGGAGE_SCAN_EVENTS (300)")
...
# 26. MISHANDLED_BAGGAGE (40)
lines.append("-- 26. MISHANDLED_BAGGAGE (40)")
...
# 27. SECURITY_CHECKPOINTS (20)
lines.append("-- 27. SECURITY_CHECKPOINTS (20)")
checkpoints_list = [
...
# 28. PASSENGER_CLEARANCE_LOGS (300)
lines.append("-- 28. PASSENGER_CLEARANCE_LOGS (300)")
...
# 29. IMMIGRATION_RECORDS (120)
lines.append("-- 29. IMMIGRATION_RECORDS (120)")
...
# 30. LOUNGE_VISITS (100)
lines.append("-- 30. LOUNGE_VISITS (100)")
...
# 31. CUSTOMER_FEEDBACK_LOGS (100)
lines.append("-- 31. CUSTOMER_FEEDBACK_LOGS (100)")
...
# 32. AIRLINE_BILLING_INVOICES (24)
lines.append("-- 32. AIRLINE_BILLING_INVOICES (24)")
...
# 33. INVOICE_LINE_ITEMS (72)
lines.append("-- 33. INVOICE_LINE_ITEMS (72)")
...
# 34. NOTIFICATIONS (150)
lines.append("-- 34. NOTIFICATIONS (150)")
notif_titles = [
...
# 35. AUDIT_LOGS (200)
lines.append("-- 35. AUDIT_LOGS (200)")
actions = [
...
print(f"Successfully generated 35-table seed dataset with 3,500+ records in {v2_path}")
